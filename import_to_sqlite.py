...
def get_congestion_score(vehicle_type, violation_list, hour):
    ...
    # Take max severity among violations in list
    viol_weight = 0.3
    if violation_list:
    ...
    # Hour multiplier (peak traffic times block lanes more severely)
    # Morning Peak: 8:00 AM - 11:30 AM (8, 9, 10, 11)
    # Evening Peak: 5:00 PM - 9:00 PM (17, 18, 19, 20)
    hour_multiplier = 1.0
    if hour in [8, 9, 10, 11]:
        ...
        hour_multiplier = 0.6 # Late night
...
with open(csv_path, mode='r', encoding='utf-8') as f:
    ...
    for i, row in enumerate(reader):
        ...
        try:
            ...
            continue # Skip records with bad coordinates
...
if batch:
    ...
    """, batch)
    conn.commit()
    print(f"Imported final batch. Total: {i+1} records.")
...
# Check coordinate bounding box of imported
